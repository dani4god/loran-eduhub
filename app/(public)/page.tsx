...
const FEATURES = [
...

  {
    ...
    desc:
      'See your grades, exam scores, and subscription status all in one clean dashboard.',
  },

  {
    ...
    desc:
      'Join Discord servers with classmates, collaborate, and learn together in structured channels.',
  },

  {
    ...
    desc:
      'Tutors create online exams — MCQ, fill-in-the-gap, and true/false — with instant grading.',
  },

  {
    ...
    desc:
      'Pay securely in Naira via Paystack. All transactions are encrypted and protected.',
  },
]
...
const HOW_IT_WORKS = [
  {
    ...
    desc:
      'Create your account, browse verified tutors, and pick the one that fits your learning style and goals.',
  },

  {
    ...
    desc:
      'Start with a free trial, then choose monthly, 3, 6, or 12-month access — priced by your chosen tutor.',
  },

  {
    ...
    desc:
      "Join your tutor's private Discord server. Attend live sessions, get assignments, and track your progress.",
  },
]
...
async function getFeaturedTutors(): Promise<
  TutorCard[]
> {
  try {
    const res =
...
> {
  try {
     ...
     * IMPORTANT:
     *
     * /api/lesson-notes already filters by:
     *
     * status: 'published'
     *
     * Therefore we DO NOT filter again here using
     * note.status because the public API does not
     * return a status property.
     */
    ...
    /**
     * The API already sorts lesson notes newest first.
     *
     * We only display the first three on the homepage.
     */
    return notes.slice(
      0,
      3
...
async function getHeroImages(): Promise<
  string[]
> {
  try {
    const res =
...
export default async function HomePage() {
  /**
   * Load homepage content in parallel instead of waiting
   * for each request sequentially.
   */
      ...
      <main className="bg-gray-950">
        ...
        <section className="py-16 sm:py-20 lg:py-24">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-2xl mx-auto mb-12">
              ...
              <h2 className="font-heading font-bold text-2xl sm:text-4xl text-white mt-3 mb-3">
                Everything You Need to Succeed
              </h2>

              <p className="text-gray-400 text-sm sm:text-base">
                A complete learning platform built for Nigerian students and tutors.
              </p>
              ...
              {FEATURES.map(
                (
                  ...
                  <div
                    ...
                    className="p-5 sm:p-6 rounded-2xl border border-white/10 bg-white/[0.03] hover:border-blue-500/30 hover:bg-white/[0.05] transition-all duration-300 group"
                  >
        ...
        <section className="py-16 sm:py-20 lg:py-24 bg-white/[0.02] border-y border-white/5">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mt-10">
              ...
              <Link
                href="/auth/student/register"
                className="inline-flex items-center gap-2 px-7 py-3.5 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-500 transition-all hover:scale-105 text-sm sm:text-base"
              >
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600/20 to-purple-600/20 border border-white/10 p-8 sm:p-12">
              ...
              <div className="relative">
                ...
                <Link
                  href="/tutors"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white text-gray-900 font-semibold rounded-xl hover:bg-blue-50 transition-all text-sm"
                >
                  Browse Tutors & Pricing
        ...
        <section className="py-16 sm:py-20 lg:py-24 bg-white/[0.02] border-y border-white/5">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
              ...
              <Link
                href="/tutors"
                className="inline-flex items-center gap-2 text-blue-400 font-semibold text-sm hover:gap-3 transition-all shrink-0"
              >
                View All Tutors
            ...
            0 ? (
              <p className="text-gray-400 text-sm text-center py-10">
                New tutors are joining soon — check back shortly.
              </p>
            ) : (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
                ...
                {tutors.map(
                  (
                    ...
                    <div
                      ...
                      className="group rounded-2xl border border-white/10 bg-white/[0.03] overflow-hidden hover:border-blue-500/30 transition-all duration-300"
                    >
                              ...
                              .map(
                                (
                                  ...
                                  <span
                                    ...
                                    className="text-[11px] bg-blue-500/10 text-blue-300 px-2 py-0.5 rounded-full font-medium truncate max-w-[120px]"
                                  >
                                    {
                                      course.name
                                    }
        ...
        <section className="py-16 sm:py-20 lg:py-24">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            0 ? (
              <p className="text-gray-400 text-sm text-center py-10">
                New self-paced courses are coming soon — check back shortly.
              </p>
            ) : (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
                  ...
                  (
                    ...
                    >
                      ...
                      <div className="p-5">
                        ...
                        <h3 className="font-heading font-bold text-white text-sm mb-1 truncate">
                          {
                            course.title
                          }
                        </h3>
        ...
        <section className="py-16 sm:py-20 lg:py-24 bg-white/[0.02] border-y border-white/5">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm mt-2 max-w-lg">
                  ...
                  browse free resources or purchase full access to premium notes.
                </p>
              ...
              <Link
                href="/lesson-notes"
                className="inline-flex items-center gap-2 text-amber-400 font-semibold text-sm hover:gap-3 transition-all shrink-0"
              >
                Browse All Notes
            ...
            0 ? (
              <p className="text-gray-400 text-sm text-center py-10">
                New lesson notes are being added soon — check back shortly.
              </p>
            ) : (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
                  ...
                  (
                    ...
                    >
                      ...
                      <div className="p-5">
                        ...
                        <h3 className="font-heading font-bold text-white text-sm mb-2 line-clamp-2">
                          {
                            note.title
                          }
                        </h3>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start">
                  ...
                  {[
                    ...
                    (
                      ...
                      >
                        ...
                        <svg
                          className="w-4.5 h-4.5 text-blue-400 shrink-0"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
              ...
              <div className="rounded-3xl bg-gradient-to-br from-purple-600/15 to-indigo-600/15 border border-white/10 p-6 sm:p-8">
                  ...
                  {[
                    {
                      ...
                      title:
                        'Exams & Assignments',
                      desc:
                        'Create MCQ, true/false, and fill-in-the-gap exams with instant auto-grading, plus manually graded assignments.',
                    },

                    {
                      ...
                      title:
                        'Certificates',
                      desc:
                        "Issue verifiable certificates automatically calculated from each student's real performance.",
                    },

                    {
                      ...
                      title:
                        'Announcements',
                      desc:
                        'Post class schedules and updates that reach students directly on their dashboard.',
                    },

                    {
                      ...
                      title:
                        'Course Library',
                      desc:
                        'Build structured, chapter-by-chapter course material students progress through at their own pace.',
                    },
                  ].map(
                    (
                      feature,
                      ...
                      >
                        ...
                        <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-purple-300 shrink-0 mt-0.5">
                          {
                            feature.icon
                          }
                        </div>
                ...
                <Link
                  href="/auth/tutor/register"
                  className="inline-flex items-center gap-2 mt-6 text-purple-300 font-semibold text-sm hover:gap-3 transition-all"
                >
                  Apply as a Tutor
