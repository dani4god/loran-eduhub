...
export default function StudentDiscordIntegration({
  initialData,
}: {
  ...
  const handleConnect = () => {
    signIn('discord', {
      callbackUrl: '/dashboard/student?tab=discord',
    })
  }
  ...
  const handleReSync = async () => {
    ...
    try {
      const res = await fetch('/api/discord/sync-student', {
        method: 'POST',
      })
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-[#5865F2] to-[#404EED] p-8 text-center">
          ...
          <div className="relative">
            ...
            <p className="text-white/80 max-w-md mx-auto text-sm">
              ...
              course roles on the Loran EduHub server.
            </p>
          </div>
        </div>
        ...
        <div className="p-8 text-center space-y-6">
          ...
          <div className="space-y-3 max-w-sm mx-auto">
            ...
            <p className="text-xs text-gray-400">
              Your Discord account doesn't need to use the same email as
              your Loran account.
            </p>
          </div>
        </div>
    ...
    <div className="space-y-5">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <p className="text-xs text-gray-400 mt-3">
          Enrolled in a new course? Click "Re-sync My Roles" after your
          enrollment is active to get the new course role automatically.
        </p>
      </div>
    </div>
  )
