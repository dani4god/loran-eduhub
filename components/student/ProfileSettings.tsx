// components/student/ProfileSettings.tsx
'use client'
...
export default function ProfileSettings() {
  ...
  useEffect(() => {
    fetch('/api/student/profile')
      ...
      .then((d) => {
        ...
        setState(d.student?.state || '')
        setProfileImage(d.student?.profileImage || null)
      })
  ...
  const save = async () => {
    ...
    try {
      const res = await fetch('/api/student/profile', {
        ...
        body: JSON.stringify({ phone, state, profileImage }),
      })
      const data = await res.json()
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5 sm:p-6">
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Update your personal details.</p>
